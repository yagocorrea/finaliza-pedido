...
export const environment = {
  production: true,
  host: '//maisdental-api.grminternet.com.br',
  hostApiCompletaCep: '//consulta-api.marlin.com.br/api/v2/recap/enderecos',
  hostApiBuscaMunicipio:
    '//consulta-api.marlin.com.br/api/v2/recap/municipios/lista',
  hostApiCompletaCpf: '//consulta-api.marlin.com.br/api/v2/recap/cpfs',
  // tokenConsultaToolkit: custom.sistema.apiCpf.token,
  _ativarAutoCompleteCpf: true,
  get ativarAutoCompleteCpf() {
    return this._ativarAutoCompleteCpf;
  },
  set ativarAutoCompleteCpf(value) {
    this._ativarAutoCompleteCpf = value;
  },
  disabilitarCamposCompletadosPorCPF: true,
  urlBasePaginaVenda: custom.sistema.urlPaginaVenda.prod,
  urlFinalizaPedido: custom.sistema.urlFinalizaPedido.prod,
  ...
  recaptchaSiteKey: '6LcA6U0bAAAAAF_4oG6UdHjY30bWEH9OpSpC5miw',
  bandeiras: {
    visa: {
      nome: 'Visa',
